...
import com.ivianuu.materialdialogs.util.isNotVisible
...
internal class DialogTitleLayout(
    ...
    override fun onLayout(
        ...
        divider.setBounds(0, 0, measuredWidth, (1 * resources.displayMetrics.density).toInt())
    }
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        if (drawDivider) {
            ...
            canvas.translate(0f, measuredHeight.toFloat() - divider.intrinsicHeight)
            divider.draw(canvas)
