...
import com.ivianuu.materialdialogs.util.isRtl
...
internal class DialogActionButtonLayout(
    ...
    private val checkBoxPromptMarginHorizontal =
        dimenPx(R.dimen.md_checkbox_prompt_margin_horizontal)
    ...
    override fun onFinishInflate() {
        ...
        for ((i, btn) in actionButtons.withIndex()) {
            val which = DialogButton.fromIndex(i)
    ...
    override fun onLayout(
        ...
        divider.setBounds(0, 0,
            measuredWidth, (1 * resources.displayMetrics.density).toInt())
    }
