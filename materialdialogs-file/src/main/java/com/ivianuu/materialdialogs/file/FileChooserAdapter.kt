...
import com.ivianuu.materialdialogs.file.util.betterParent
import com.ivianuu.materialdialogs.file.util.friendlyName
import com.ivianuu.materialdialogs.file.util.hasParent
import com.ivianuu.materialdialogs.file.util.jumpOverEmulated
import com.ivianuu.materialdialogs.file.util.maybeSetTextColor
import com.ivianuu.materialdialogs.file.util.setVisible
...
internal class FileChooserAdapter(
  ...
  private val folderCreationLabel: Int?,
  ...
  private val isLightTheme =
    resolveColor(dialog.context, attr = android.R.attr.textColorPrimary).isColorDark()
  ...
  override fun onCreateViewHolder(
    ...
    viewHolder.nameView.maybeSetTextColor(dialog.context, R.attr.md_color_content)
    return viewHolder
  }
  ...
  override fun onBindViewHolder(
    ...
    if (allowFolderCreation && currentFolder.canWrite() && position == newFolderIndex()) {
      ...
      holder.nameView.text = dialog.context.getString(
